 ...
 */
int obs_query_max_t(ObsStore *store, char const *const site, time_t start_time,
 ...
 * window starts at \c start_time, and each subsequent window starts 24 hours later.
 */
int obs_query_min_t(ObsStore *store, char const *const site, time_t start_time,
                    time_t end_time, unsigned window_length, struct TemperatureOb **results,
                    size_t *num_results);
